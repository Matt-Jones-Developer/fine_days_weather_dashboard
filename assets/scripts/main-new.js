...
// dataConversion(data) - creates an object of each data into readable
// fetchWeatherForecast() OR split into 2:
// fetchCurrentWeather() - includes the API fetch (if required?)
// fetchFiveDayForecast() - includes the other API fetch
// renderElements()
...
searchBtn.addEventListener("click", function (event) {
    ...
    if (historyArray === undefined || historyArray.length == 0) {
        ...
        // fetchCurrentWeather()
        // are we needing both weather and forecast?? TEST
    }
})
...
//     alert('already contains a value!')
//     // clear viewer
//     $('#forecast').empty();
